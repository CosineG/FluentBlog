...
{
    public class CustomIdentityErrorDescriberZhHans : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = nameof(PasswordTooShort), Description = $"密码至少包含{length}个字符." };
        }
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric()
        {
            return new IdentityError
            {
                ...
                Description = "密码至少包含一个非字母数字字符."
            };
        }

        public override IdentityError PasswordRequiresDigit()
        {
            return new IdentityError { Code = nameof(PasswordRequiresDigit), Description = $"密码至少包含一个数字('0'-'9')." };
        }
        ...
        {
            return new IdentityError { Code = nameof(PasswordRequiresLower), Description = "密码至少包含一个小写字母('a'-'z')." };
        }

        public override IdentityError PasswordRequiresUpper()
        {
            return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = "密码至少包含一个大写字母('A'-'Z')." };
        }
